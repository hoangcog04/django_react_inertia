          ...
          style={
            {
              ...
              // fix: bg-sidebar below does not work, so we use this
...
function Sidebar({
  ...
  // Calculate spacer width based on state
  ...
  const getSidebarWidth = () => {
    ...
    if (state === "collapsed" && collapsible === "icon") {
      if (variant === "floating" || variant === "inset") {
        return "calc(var(--sidebar-width-icon) + var(--spacing) * 4 + 2px)"
      }
      return "var(--sidebar-width-icon)"
    }
    return "var(--sidebar-width)"
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative h-svh w-[calc(var(--sidebar-width))] bg-transparent transition-[width] duration-200 ease-linear",
      ...
      <div
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-[calc(var(--sidebar-width))] transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
          ...
          variant === "floating" || variant === "inset"
            ...
            : "group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon))] group-data-[side=left]:border-r group-data-[side=right]:border-l",
          className
        )}
        {...props}
      >
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]:min-h-[calc(100svh-(var(--spacing)*4))] md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm",
        className
      )}
      {...props}
    />
